  ...
  return (
    <section className="relative bg-stone-900 overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-r from-stone-900/95 via-stone-900/70 to-stone-900/20"></div>
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
        <div className="max-w-3xl">
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <span className="text-blue-700 text-sm tracking-wider uppercase">Kmen Trilobit</span>
          </div>
          ...
          <p className="text-xl sm:text-2xl text-stone-200 mb-10">
            Pravidelné výpravy, hry a zážitky v přírodě pro děti. Choltice a okolí.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <div className="flex flex-col gap-2">
              ...
              <span className="text-stone-400 text-sm text-center">Odpovídáme do 24 hodin</span>
            </div>
            <button 
