    ...
    <section className="py-16 lg:py-24 bg-stone-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 mb-10">
          {events.map((event, index) => (
            ...
            >
              ...
              <button className="text-blue-900 hover:text-blue-950 transition-colors flex items-center gap-2 font-medium">
        ...
        <div className="text-center">
          <button className="text-blue-900 hover:text-blue-950 transition-colors inline-flex items-center gap-2 border-2 border-blue-900 rounded-full px-8 py-3">
